...
/**
 * Deploys the Token contract from Ethernaut level 5
 *
...
const deployToken: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log("Deploying Token contract with account:", deployer);

  const initialSupply = 100_000e18;
...
deployToken.tags = ["level-05", "token"];
